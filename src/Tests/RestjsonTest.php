...
/**
 * @file
 * Contains Drupal\restjson\Tests\RestjsonTest.
 */

namespace Drupal\restjson\Tests;
...
/**
 * Tests Restjson installation profile expectations.
 *
 * @group restjson
 */
class RestjsonTest extends WebTestBase {

  use SchemaCheckTestTrait;

  protected $profile = 'restjson';
  ...
  /**
   * Tests Restjson installation profile.
   */
  function testRestjson() {
    $this->drupalGet('');
    ...
    // restjson profile modules are enabled.
    ...
    // Ensure that configuration from the Restjson profile is not reused when
